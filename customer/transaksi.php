...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-primary text-white">
        <div class="container">
          <a class="navbar-brand bg-primary text-white" href="../index.html">Hotelin.id</a>
      ...
      <main>
        <div class="container-fluid px-4">
            ...
            <tbody>
            <?php 
                $query = oci_parse($koneksi,"SELECT t.no_transaksi, t.id_pelanggan, k.no_kamar , k.tipe_kamar, k.harga_kamar, t.lama_menginap, tarif(harga_kamar, lama_menginap) FROM transaksi t, kamar k WHERE t.no_kamar = k.no_kamar ORDER BY t.no_transaksi");
                oci_execute($query);
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo $data["LAMA_MENGINAP"] ?></td>
