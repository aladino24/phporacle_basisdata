...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE pelanggan SET nama = '$nama', alamat = '$alamat', no_telp = '$no_telp', jenis_kelamin = '$jenis_kelamin', status = '$status', username = '$username', password = 'password'  WHERE id_pelanggan = '$id_pelanggan'";
